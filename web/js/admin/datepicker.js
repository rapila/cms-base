...
DatePicker.prototype	= {
 ...
 initialize	: function ( h_p ) {
  ...
  this._div.innerHTML = '<table><thead><tr><th style="width: 10px;cursor: pointer;" id="'+this._id_datepicker_prev+'">&#160;&lt;&lt;&#160;</th><th id="'+this._id_datepicker_hdr+'" colspan="5"></th><th id="'+this._id_datepicker_next+'" style="cursor: pointer;width: 10px;">&#160;&gt;&gt;&#160;</th></tr></thead><tbody id="'+this._id_datepicker+'-tbody"></tbody><tfoot><tr><td colspan="7" id="'+this._id_datepicker_ftr+'"></td></tr></tfoot></table>';
  /* finally declare the event listener on input field */
  Event.observe(this._relative, 
    'focus', this.click.bindAsEventListener(this), false);
