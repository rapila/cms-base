	...
	$.jstree.plugin("themeroller", {
		__init : function () {
			...
			this.get_container()
				...
				.delegate("li","mouseenter.jstree", function (e) {
					if(!$(e.currentTarget).hasClass("jstree-loading")) {
				...
				.bind("deselect_node.jstree deselect_all.jstree", $.proxy(function (e, data) {
						this.get_container()
							.find("li." + s.item_a).removeClass(s.item_a).end()
							.find("li.jstree-clicked").addClass(s.item_a);
					}, this))
				.bind("dehover_node.jstree", $.proxy(function (e, data) {
						data.rslt.obj.removeClass(s.item_h);
					}, this))
				.bind("hover_node.jstree", $.proxy(function (e, data) {
						this.get_container()
							.find("li." + s.item_h).not(data.rslt.obj).removeClass(s.item_h);
						data.rslt.obj.addClass(s.item_h);
					}, this))
				.bind("move_node.jstree", $.proxy(function (e, data) {
