...
/**
 * This class adds structure of 'documents' table to 'mini_cms' DatabaseMap object.
 *
 *
 *
...
class DocumentMapBuilder {
	 ...
	 */
	const CLASS_NAME = 'model.map.DocumentMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('documents');
		...
		$tMap->addForeignKey('DOCUMENT_TYPE_ID', 'DocumentTypeId', 'int', CreoleTypes::INTEGER, 'document_types', 'ID', true, null);

		$tMap->addForeignKey('DOCUMENT_CATEGORY_ID', 'DocumentCategoryId', 'int', CreoleTypes::INTEGER, 'document_categories', 'ID', false, null);
