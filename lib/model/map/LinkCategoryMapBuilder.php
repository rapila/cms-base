...
/**
 * This class adds structure of 'link_categories' table to 'mini_cms' DatabaseMap object.
 *
 *
 *
...
class LinkCategoryMapBuilder {
	 ...
	 */
	const CLASS_NAME = 'model.map.LinkCategoryMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('link_categories');
