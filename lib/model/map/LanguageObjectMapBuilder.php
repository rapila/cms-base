...
/**
 * This class adds structure of 'language_objects' table to 'mini_cms' DatabaseMap object.
 *
 *
 *
 ...
 * @package    model.map
 */
class LanguageObjectMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'model.map.LanguageObjectMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('language_objects');
		$tMap->setPhpName('LanguageObject');
