...
abstract class BaseUserRolePeer {
	...
	const CLASS_DEFAULT = 'model.UserRole';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::USER_ID, self::ROLE_KEY, self::CREATED_AT, self::UPDATED_AT, self::CREATED_BY, self::UPDATED_BY, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::USER_ID => 0, self::ROLE_KEY => 1, self::CREATED_AT => 2, self::UPDATED_AT => 3, self::CREATED_BY => 4, self::UPDATED_BY => 5, ),
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = UserRolePeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + UserRolePeer::NUM_COLUMNS;
		} else {
	...
	public static function doSelectJoinUserRelatedByUserId(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		UserRolePeer::addSelectColumns($criteria);
		$startcol = (UserRolePeer::NUM_COLUMNS - UserRolePeer::NUM_LAZY_LOAD_COLUMNS);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		UserRolePeer::addSelectColumns($criteria);
		$startcol2 = (UserRolePeer::NUM_COLUMNS - UserRolePeer::NUM_LAZY_LOAD_COLUMNS);
	...
	/**
	 * Method to DELETE all rows from the user_roles table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
