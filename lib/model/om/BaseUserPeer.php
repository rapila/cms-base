...
abstract class BaseUserPeer {
	...
	public static function clearRelatedInstancePool()
	{
		...
		// since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
		ReferencePeer::clearInstancePool();
		// Invalidate objects in NewsletterPeer instance pool, 
		// since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
		...
		// Invalidate objects in SubscriberPeer instance pool, 
		// since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
		...
		// since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
		SubscriberGroupMembershipPeer::clearInstancePool();
		// Invalidate objects in SubscriberGroupPeer instance pool, 
		// since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
		SubscriberGroupPeer::clearInstancePool();
		// Invalidate objects in SubscriberGroupPeer instance pool, 
		// since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
		SubscriberGroupPeer::clearInstancePool();
		// Invalidate objects in TipStringPeer instance pool, 
		// since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
		TipStringPeer::clearInstancePool();
		// Invalidate objects in TipStringPeer instance pool, 
		// since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
		TipStringPeer::clearInstancePool();
		// Invalidate objects in TipPeer instance pool, 
		// since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
		TipPeer::clearInstancePool();
		// Invalidate objects in TipPeer instance pool, 
		// since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
		TipPeer::clearInstancePool();
		// Invalidate objects in TipCategoryPeer instance pool, 
		// since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
		TipCategoryPeer::clearInstancePool();
		// Invalidate objects in TipCategoryPeer instance pool, 
		// since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
		TipCategoryPeer::clearInstancePool();
		// Invalidate objects in FrontendUserPeer instance pool, 
		// since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
		FrontendUserPeer::clearInstancePool();
		// Invalidate objects in FrontendUserPeer instance pool, 
		// since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
		FrontendUserPeer::clearInstancePool();
		// Invalidate objects in FrontendUserPeer instance pool, 
		...
		// since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
		GamePeer::clearInstancePool();
		// Invalidate objects in EpisodePeer instance pool, 
		// since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
		EpisodePeer::clearInstancePool();
		// Invalidate objects in EpisodePeer instance pool, 
		// since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
		EpisodePeer::clearInstancePool();
		// Invalidate objects in EpisodeTypePeer instance pool, 
		// since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
		EpisodeTypePeer::clearInstancePool();
		// Invalidate objects in EpisodeTypePeer instance pool, 
		// since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
		EpisodeTypePeer::clearInstancePool();
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related FrontendUser objects
			$criteria = new Criteria(FrontendUserPeer::DATABASE_NAME);
			
			$criteria->add(FrontendUserPeer::USER_ID, $obj->getId());
			$affectedRows += FrontendUserPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
	...
	protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// set fkey col in related Newsletter rows to NULL
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(NewsletterPeer::CREATED_BY, $obj->getId());
			$updateValues->add(NewsletterPeer::CREATED_BY, null);
			...
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(NewsletterPeer::UPDATED_BY, $obj->getId());
			$updateValues->add(NewsletterPeer::UPDATED_BY, null);

			BasePeer::doUpdate($selectCriteria, $updateValues, $con); // use BasePeer because generated Peer doUpdate() methods only update using pkey

			// set fkey col in related NewsletterMailing rows to NULL
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(NewsletterMailingPeer::UPDATED_BY, $obj->getId());
			$updateValues->add(NewsletterMailingPeer::UPDATED_BY, null);

			BasePeer::doUpdate($selectCriteria, $updateValues, $con); // use BasePeer because generated Peer doUpdate() methods only update using pkey

			// set fkey col in related Subscriber rows to NULL
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(SubscriberPeer::CREATED_BY, $obj->getId());
			$updateValues->add(SubscriberPeer::CREATED_BY, null);
			...
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(SubscriberPeer::UPDATED_BY, $obj->getId());
			$updateValues->add(SubscriberPeer::UPDATED_BY, null);

			BasePeer::doUpdate($selectCriteria, $updateValues, $con); // use BasePeer because generated Peer doUpdate() methods only update using pkey

			// set fkey col in related SubscriberGroupMembership rows to NULL
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(SubscriberGroupMembershipPeer::CREATED_BY, $obj->getId());
			$updateValues->add(SubscriberGroupMembershipPeer::CREATED_BY, null);
			...
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(SubscriberGroupMembershipPeer::UPDATED_BY, $obj->getId());
			$updateValues->add(SubscriberGroupMembershipPeer::UPDATED_BY, null);

			BasePeer::doUpdate($selectCriteria, $updateValues, $con); // use BasePeer because generated Peer doUpdate() methods only update using pkey

			// set fkey col in related SubscriberGroup rows to NULL
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(SubscriberGroupPeer::CREATED_BY, $obj->getId());
			$updateValues->add(SubscriberGroupPeer::CREATED_BY, null);
			...
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(SubscriberGroupPeer::UPDATED_BY, $obj->getId());
			$updateValues->add(SubscriberGroupPeer::UPDATED_BY, null);

			BasePeer::doUpdate($selectCriteria, $updateValues, $con); // use BasePeer because generated Peer doUpdate() methods only update using pkey

			// set fkey col in related TipString rows to NULL
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(TipStringPeer::CREATED_BY, $obj->getId());
			$updateValues->add(TipStringPeer::CREATED_BY, null);
			...
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(TipStringPeer::UPDATED_BY, $obj->getId());
			$updateValues->add(TipStringPeer::UPDATED_BY, null);

			BasePeer::doUpdate($selectCriteria, $updateValues, $con); // use BasePeer because generated Peer doUpdate() methods only update using pkey

			// set fkey col in related Tip rows to NULL
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(TipPeer::CREATED_BY, $obj->getId());
			$updateValues->add(TipPeer::CREATED_BY, null);
			...
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(TipPeer::UPDATED_BY, $obj->getId());
			$updateValues->add(TipPeer::UPDATED_BY, null);

			BasePeer::doUpdate($selectCriteria, $updateValues, $con); // use BasePeer because generated Peer doUpdate() methods only update using pkey

			// set fkey col in related TipCategory rows to NULL
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(TipCategoryPeer::CREATED_BY, $obj->getId());
			$updateValues->add(TipCategoryPeer::CREATED_BY, null);
			...
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(TipCategoryPeer::UPDATED_BY, $obj->getId());
			$updateValues->add(TipCategoryPeer::UPDATED_BY, null);

			BasePeer::doUpdate($selectCriteria, $updateValues, $con); // use BasePeer because generated Peer doUpdate() methods only update using pkey

			// set fkey col in related FrontendUser rows to NULL
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(FrontendUserPeer::CREATED_BY, $obj->getId());
			$updateValues->add(FrontendUserPeer::CREATED_BY, null);
			...
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(FrontendUserPeer::UPDATED_BY, $obj->getId());
			$updateValues->add(FrontendUserPeer::UPDATED_BY, null);

			BasePeer::doUpdate($selectCriteria, $updateValues, $con); // use BasePeer because generated Peer doUpdate() methods only update using pkey

			// set fkey col in related Score rows to NULL
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(ScorePeer::CREATED_BY, $obj->getId());
			$updateValues->add(ScorePeer::CREATED_BY, null);
			...
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(ScorePeer::UPDATED_BY, $obj->getId());
			$updateValues->add(ScorePeer::UPDATED_BY, null);

			BasePeer::doUpdate($selectCriteria, $updateValues, $con); // use BasePeer because generated Peer doUpdate() methods only update using pkey

			// set fkey col in related Game rows to NULL
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(GamePeer::CREATED_BY, $obj->getId());
			$updateValues->add(GamePeer::CREATED_BY, null);
			...
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(GamePeer::UPDATED_BY, $obj->getId());
			$updateValues->add(GamePeer::UPDATED_BY, null);

			BasePeer::doUpdate($selectCriteria, $updateValues, $con); // use BasePeer because generated Peer doUpdate() methods only update using pkey

			// set fkey col in related Episode rows to NULL
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(EpisodePeer::CREATED_BY, $obj->getId());
			$updateValues->add(EpisodePeer::CREATED_BY, null);
			...
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(EpisodePeer::UPDATED_BY, $obj->getId());
			$updateValues->add(EpisodePeer::UPDATED_BY, null);

			BasePeer::doUpdate($selectCriteria, $updateValues, $con); // use BasePeer because generated Peer doUpdate() methods only update using pkey

			// set fkey col in related EpisodeType rows to NULL
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(EpisodeTypePeer::CREATED_BY, $obj->getId());
			$updateValues->add(EpisodeTypePeer::CREATED_BY, null);
			...
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(EpisodeTypePeer::UPDATED_BY, $obj->getId());
			$updateValues->add(EpisodeTypePeer::UPDATED_BY, null);
			...
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(CommentPeer::CREATED_BY, $obj->getId());
			$updateValues->add(CommentPeer::CREATED_BY, null);
			...
			$selectCriteria = new Criteria(UserPeer::DATABASE_NAME);
			$updateValues = new Criteria(UserPeer::DATABASE_NAME);
			$selectCriteria->add(CommentPeer::UPDATED_BY, $obj->getId());
			$updateValues->add(CommentPeer::UPDATED_BY, null);
