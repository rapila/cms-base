...
abstract class BaseLanguageObjectPeer
{
     ...
     * e.g. LanguageObjectPeer::$fieldNames[LanguageObjectPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (LanguageObjectPeer::OBJECT_ID, LanguageObjectPeer::LANGUAGE_ID, LanguageObjectPeer::DATA, LanguageObjectPeer::HAS_DRAFT, LanguageObjectPeer::CREATED_AT, LanguageObjectPeer::UPDATED_AT, LanguageObjectPeer::CREATED_BY, LanguageObjectPeer::UPDATED_BY, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. LanguageObjectPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (LanguageObjectPeer::OBJECT_ID => 0, LanguageObjectPeer::LANGUAGE_ID => 1, LanguageObjectPeer::DATA => 2, LanguageObjectPeer::HAS_DRAFT => 3, LanguageObjectPeer::CREATED_AT => 4, LanguageObjectPeer::UPDATED_AT => 5, LanguageObjectPeer::CREATED_BY => 6, LanguageObjectPeer::UPDATED_BY => 7, ),
    ...
    {
        $toNames = LanguageObjectPeer::getFieldNames($toType);
        $key = isset(LanguageObjectPeer::$fieldKeys[$fromType][$name]) ? LanguageObjectPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(LanguageObjectPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, LanguageObjectPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return LanguageObjectPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(LanguageObjectPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(LanguageObjectPeer::DATABASE_NAME);
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            LanguageObjectPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(LanguageObjectPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(LanguageObjectPeer::$instances[$key])) {
                return LanguageObjectPeer::$instances[$key];
            }
        }
    ...
    {
        return Propel::getDatabaseMap(LanguageObjectPeer::DATABASE_NAME)->getTable(LanguageObjectPeer::TABLE_NAME);
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(LanguageObjectPeer::DATABASE_NAME);
