...
// actual class may be a subclass -- as returned by LanguageObjectHistoryPeer::getOMClass()
...
abstract class BaseLanguageObjectHistoryPeer {
	...
	const CLASS_DEFAULT = 'model.LanguageObjectHistory';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('ObjectId', 'LanguageId', 'Data', 'Revision', 'CreatedBy', 'CreatedAt', ),
		BasePeer::TYPE_COLNAME => array (LanguageObjectHistoryPeer::OBJECT_ID, LanguageObjectHistoryPeer::LANGUAGE_ID, LanguageObjectHistoryPeer::DATA, LanguageObjectHistoryPeer::REVISION, LanguageObjectHistoryPeer::CREATED_BY, LanguageObjectHistoryPeer::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('object_id', 'language_id', 'data', 'revision', 'created_by', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('ObjectId' => 0, 'LanguageId' => 1, 'Data' => 2, 'Revision' => 3, 'CreatedBy' => 4, 'CreatedAt' => 5, ),
		BasePeer::TYPE_COLNAME => array (LanguageObjectHistoryPeer::OBJECT_ID => 0, LanguageObjectHistoryPeer::LANGUAGE_ID => 1, LanguageObjectHistoryPeer::DATA => 2, LanguageObjectHistoryPeer::REVISION => 3, LanguageObjectHistoryPeer::CREATED_BY => 4, LanguageObjectHistoryPeer::CREATED_AT => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('object_id' => 0, 'language_id' => 1, 'data' => 2, 'revision' => 3, 'created_by' => 4, 'created_at' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	{
		include_once 'model/map/LanguageObjectHistoryMapBuilder.php';
		return BasePeer::getMapBuilder('model.map.LanguageObjectHistoryMapBuilder');
	}
	/**
	...
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = LanguageObjectHistoryPeer::getTableMap();
	...
	const COUNT = 'COUNT(language_object_history.OBJECT_ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT language_object_history.OBJECT_ID)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(LanguageObjectHistoryPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(LanguageObjectHistoryPeer::COUNT);
		}
		...
		$rs = LanguageObjectHistoryPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
	...
	{
		return LanguageObjectHistoryPeer::populateObjects(LanguageObjectHistoryPeer::doSelectRS($criteria, $con));
	}
	/**
	...
	public static function doCountJoinContentObject(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(LanguageObjectHistoryPeer::OBJECT_ID, ContentObjectPeer::ID);
	...
	public static function doCountJoinLanguage(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(LanguageObjectHistoryPeer::LANGUAGE_ID, LanguagePeer::ID);
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(LanguageObjectHistoryPeer::CREATED_BY, UserPeer::ID);
	...
	public static function doSelectJoinContentObject(Criteria $c, $con = null)
	{
		...
		LanguageObjectHistoryPeer::addSelectColumns($c);
		$startcol = (LanguageObjectHistoryPeer::NUM_COLUMNS - LanguageObjectHistoryPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		ContentObjectPeer::addSelectColumns($c);

		$c->addJoin(LanguageObjectHistoryPeer::OBJECT_ID, ContentObjectPeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();

		while($rs->next()) {

			$omClass = LanguageObjectHistoryPeer::getOMClass();
			...
			foreach($results as $temp_obj1) {
				...
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					...
					$temp_obj2->addLanguageObjectHistory($obj1); //CHECKME
					break;
				}
			}
			if ($newObject) {
				$obj2->initLanguageObjectHistorys();
				$obj2->addLanguageObjectHistory($obj1); //CHECKME
			}
			$results[] = $obj1;
		}
		return $results;
	...
	public static function doSelectJoinLanguage(Criteria $c, $con = null)
	{
		...
		$c->addJoin(LanguageObjectHistoryPeer::LANGUAGE_ID, LanguagePeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
	...
	public static function doSelectJoinUser(Criteria $c, $con = null)
	{
		...
		$c->addJoin(LanguageObjectHistoryPeer::CREATED_BY, UserPeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		LanguageObjectHistoryPeer::addSelectColumns($c);
		$startcol2 = (LanguageObjectHistoryPeer::NUM_COLUMNS - LanguageObjectHistoryPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				...
				if ($temp_obj3->getPrimaryKey() === $obj3->getPrimaryKey()) {
					$newObject = false;
					$temp_obj3->addLanguageObjectHistory($obj1); // CHECKME
					break;
				}
			}

			if ($newObject) {
				$obj3->initLanguageObjectHistorys();
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				...
				if ($temp_obj4->getPrimaryKey() === $obj4->getPrimaryKey()) {
					$newObject = false;
					$temp_obj4->addLanguageObjectHistory($obj1); // CHECKME
					break;
				}
			}

			if ($newObject) {
				$obj4->initLanguageObjectHistorys();
				$obj4->addLanguageObjectHistory($obj1);
			}
	...
	public static function doSelectJoinAllExceptContentObject(Criteria $c, $con = null)
	{
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				...
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
					$temp_obj2->addLanguageObjectHistory($obj1);
					break;
				}
			}
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				...
				if ($temp_obj3->getPrimaryKey() === $obj3->getPrimaryKey()) {
					$newObject = false;
					$temp_obj3->addLanguageObjectHistory($obj1);
					break;
				}
			}
	...
	/**
	 * Selects a collection of LanguageObjectHistory objects pre-filled with all related objects except User.
	 *
	 * @return     array Array of LanguageObjectHistory objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	...
	{
		return LanguageObjectHistoryPeer::CLASS_DEFAULT;
	}

	/**
	 * Method perform an INSERT on the database, given a LanguageObjectHistory or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a LanguageObjectHistory or Criteria object.
	 *
	...
	public static function doUpdate($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(LanguageObjectHistoryPeer::OBJECT_ID, $criteria->remove(LanguageObjectHistoryPeer::OBJECT_ID), $comparison);

			$comparison = $criteria->getComparison(LanguageObjectHistoryPeer::LANGUAGE_ID);
			$selectCriteria->add(LanguageObjectHistoryPeer::LANGUAGE_ID, $criteria->remove(LanguageObjectHistoryPeer::LANGUAGE_ID), $comparison);

			$comparison = $criteria->getComparison(LanguageObjectHistoryPeer::REVISION);
			$selectCriteria->add(LanguageObjectHistoryPeer::REVISION, $criteria->remove(LanguageObjectHistoryPeer::REVISION), $comparison);
	...
	/**
	 * Method to DELETE all rows from the language_object_history table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->begin();
			$affectedRows += BasePeer::doDeleteAll(LanguageObjectHistoryPeer::TABLE_NAME, $con);
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollback();
	...
	/**
	 * Method perform a DELETE on the database, given a LanguageObjectHistory or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; // rename for clarity
		} elseif ($values instanceof LanguageObjectHistory) {
			...
			$criteria->add(LanguageObjectHistoryPeer::OBJECT_ID, $vals[0], Criteria::IN);
			$criteria->add(LanguageObjectHistoryPeer::LANGUAGE_ID, $vals[1], Criteria::IN);
			$criteria->add(LanguageObjectHistoryPeer::REVISION, $vals[2], Criteria::IN);
		}
	 ...
	 */
	public static function doValidate(LanguageObjectHistory $obj, $cols = null)
	{
		$columns = array();
	 ...
	 * @return     LanguageObjectHistory
	 */
	public static function retrieveByPK( $object_id, $language_id, $revision, $con = null) {
		if ($con === null) {
			$con = Propel::getConnection(self::DATABASE_NAME);
		}
...
if (Propel::isInit()) {
	...
	try {
		BaseLanguageObjectHistoryPeer::getMapBuilder();
	} catch (Exception $e) {
	...
	require_once 'model/map/LanguageObjectHistoryMapBuilder.php';
	Propel::registerMapBuilder('model.map.LanguageObjectHistoryMapBuilder');
}
