  ...
  const PEER = 'StringPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->language_id = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			$this->string_key = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			...
			return $startcol + 7; // 7 = StringPeer::NUM_COLUMNS - StringPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	{
		return (null === $this->getLanguageId()) && (null === $this->getStringKey());
	}
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setStringKey($this->string_key);
