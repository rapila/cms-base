...
// actual class may be a subclass -- as returned by ReferencePeer::getOMClass()
...
abstract class BaseReferencePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'FromId', 'FromModelName', 'ToId', 'ToModelName', ),
		BasePeer::TYPE_COLNAME => array (ReferencePeer::ID, ReferencePeer::FROM_ID, ReferencePeer::FROM_MODEL_NAME, ReferencePeer::TO_ID, ReferencePeer::TO_MODEL_NAME, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'from_id', 'from_model_name', 'to_id', 'to_model_name', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'FromId' => 1, 'FromModelName' => 2, 'ToId' => 3, 'ToModelName' => 4, ),
		BasePeer::TYPE_COLNAME => array (ReferencePeer::ID => 0, ReferencePeer::FROM_ID => 1, ReferencePeer::FROM_MODEL_NAME => 2, ReferencePeer::TO_ID => 3, ReferencePeer::TO_MODEL_NAME => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'from_id' => 1, 'from_model_name' => 2, 'to_id' => 3, 'to_model_name' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	{
		include_once 'model/map/ReferenceMapBuilder.php';
		return BasePeer::getMapBuilder('model.map.ReferenceMapBuilder');
	}
	/**
	...
	const COUNT = 'COUNT(indirect_references.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT indirect_references.ID)';
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(ReferencePeer::ID); // remove pkey col since this table uses auto-increment
	 ...
	 */
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; // rename for clarity
		} elseif ($values instanceof Reference) {
...
if (Propel::isInit()) {
	...
	require_once 'model/map/ReferenceMapBuilder.php';
	Propel::registerMapBuilder('model.map.ReferenceMapBuilder');
}
