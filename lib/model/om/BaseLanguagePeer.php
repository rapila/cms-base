...
abstract class BaseLanguagePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'IsActive', 'Sort', ),
		BasePeer::TYPE_COLNAME => array (LanguagePeer::ID, LanguagePeer::IS_ACTIVE, LanguagePeer::SORT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'is_active', 'sort', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'IsActive' => 1, 'Sort' => 2, ),
		BasePeer::TYPE_COLNAME => array (LanguagePeer::ID => 0, LanguagePeer::IS_ACTIVE => 1, LanguagePeer::SORT => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'is_active' => 1, 'sort' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	{
		include_once 'model/map/LanguageMapBuilder.php';
		return BasePeer::getMapBuilder('model.map.LanguageMapBuilder');
	}
	/**
...
if (Propel::isInit()) {
	...
	require_once 'model/map/LanguageMapBuilder.php';
	Propel::registerMapBuilder('model.map.LanguageMapBuilder');
}
