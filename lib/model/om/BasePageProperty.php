...
abstract class BasePageProperty extends BaseObject  implements Persistent
{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(PagePropertyPeer::ID) ) {
					...
					$affectedRows += PagePropertyPeer::doUpdate($this, $con);
				}
	...
	public function mayOperate($sOperation, $oUser = false) {
		...
		return PagePropertyPeer::mayOperateOn($oUser, $this, $sOperation);
	}
