...
abstract class BaseTag extends BaseObject implements Persistent
{
    ...
    protected $collTagInstancesPartial;
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = TagPeer::UPDATED_BY;
        }
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->collTagInstances) {
                $result['TagInstances'] = $this->collTagInstances->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TagPeer::UPDATED_BY)) $criteria->add(TagPeer::UPDATED_BY, $this->updated_by);
    ...
    {
        if ('TagInstance' == $relationName) {
            $this->initTagInstances();
        }
    }

    /**
     * Clears out the collTagInstances collection
     *
    ...
    /**
     * reset is the collTagInstances collection loaded partially
     *
     * @return void
     */
    public function resetPartialTagInstances($v = true)
    {
        $this->collTagInstancesPartial = $v;
    }

    /**
     * Initializes the collTagInstances collection.
     *
     * By default this just sets the collTagInstances collection to an empty array (like clearcollTagInstances());
     ...
     * @return void
     */
    public function initTagInstances($overrideExisting = true)
    {
        if (null !== $this->collTagInstances && !$overrideExisting) {
            return;
        }
        $this->collTagInstances = new PropelObjectCollection();
        $this->collTagInstances->setModel('TagInstance');
    }
     ...
     * @throws PropelException
     */
    public function getTagInstances($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collTagInstancesPartial && !$this->isNew();
        if (null === $this->collTagInstances || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collTagInstances) {
                // return empty collection
                $this->initTagInstances();
            } else {
                $collTagInstances = TagInstanceQuery::create(null, $criteria)
                    ->filterByTag($this)
                    ->find($con);
                if (null !== $criteria) {
                ...
                $this->collTagInstances = $collTagInstances;
     ...
     * @throws PropelException
     */
    public function countTagInstances(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        $partial = $this->collTagInstancesPartial && !$this->isNew();
        if (null === $this->collTagInstances || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collTagInstances) {
    ...
    {
        if ($this->getTagInstances()->contains($tagInstance)) {
            $this->collTagInstances->remove($this->collTagInstances->search($tagInstance));
            if (null === $this->tagInstancesScheduledForDeletion) {
     ...
     * @return PropelObjectCollection|TagInstance[] List of TagInstance objects
     */
    public function getTagInstancesJoinUserRelatedByCreatedBy($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = TagInstanceQuery::create(null, $criteria);
        $query->joinWith('UserRelatedByCreatedBy', $join_behavior);

        return $this->getTagInstances($query, $con);
    }
     ...
     * @return PropelObjectCollection|TagInstance[] List of TagInstance objects
     */
    public function getTagInstancesJoinUserRelatedByUpdatedBy($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = TagInstanceQuery::create(null, $criteria);
    ...
    public function clearAllReferences($deep = false)
    {
        ...
        if ($this->collTagInstances instanceof PropelCollection) {
            $this->collTagInstances->clearIterator();
        }
        $this->collTagInstances = null;
        $this->aUserRelatedByCreatedBy = null;
        $this->aUserRelatedByUpdatedBy = null;
    ...
    public function mayOperate($sOperation, $oUser = false) {
        ...
        if($oUser && ($this->isNew() || $this->getCreatedBy() === $oUser->getId()) && TagPeer::mayOperateOnOwn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        } else if(TagPeer::mayOperateOn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        }
        FilterModule::getFilters()->handleTagOperationCheck($sOperation, $this, $oUser, array(&$bIsAllowed));
        return $bIsAllowed;
    }
