 ...
 * @method DocumentDataQuery orderByUpdatedBy($order = Criteria::ASC) Order by the updated_by column
 *
 ...
 * @method DocumentDataQuery groupByUpdatedBy() Group by the updated_by column
 *
 * @method DocumentDataQuery leftJoin($relation) Adds a LEFT JOIN clause to the query
 * @method DocumentDataQuery rightJoin($relation) Adds a RIGHT JOIN clause to the query
 * @method DocumentDataQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method DocumentDataQuery leftJoinUserRelatedByCreatedBy($relationAlias = null) Adds a LEFT JOIN clause to the query using the UserRelatedByCreatedBy relation
 * @method DocumentDataQuery rightJoinUserRelatedByCreatedBy($relationAlias = null) Adds a RIGHT JOIN clause to the query using the UserRelatedByCreatedBy relation
 * @method DocumentDataQuery innerJoinUserRelatedByCreatedBy($relationAlias = null) Adds a INNER JOIN clause to the query using the UserRelatedByCreatedBy relation
 *
 * @method DocumentDataQuery leftJoinUserRelatedByUpdatedBy($relationAlias = null) Adds a LEFT JOIN clause to the query using the UserRelatedByUpdatedBy relation
 * @method DocumentDataQuery rightJoinUserRelatedByUpdatedBy($relationAlias = null) Adds a RIGHT JOIN clause to the query using the UserRelatedByUpdatedBy relation
 * @method DocumentDataQuery innerJoinUserRelatedByUpdatedBy($relationAlias = null) Adds a INNER JOIN clause to the query using the UserRelatedByUpdatedBy relation
 *
 * @method DocumentDataQuery leftJoinDocument($relationAlias = null) Adds a LEFT JOIN clause to the query using the Document relation
 * @method DocumentDataQuery rightJoinDocument($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Document relation
 * @method DocumentDataQuery innerJoinDocument($relationAlias = null) Adds a INNER JOIN clause to the query using the Document relation
 *
 * @method DocumentData findOne(PropelPDO $con = null) Return the first DocumentData matching the query
 ...
 * @method DocumentData findOneByUpdatedBy(int $updated_by) Return the first DocumentData filtered by the updated_by column
 *
 ...
 * @method array findByUpdatedBy(int $updated_by) Return DocumentData objects filtered by the updated_by column
 *
 * @package    propel.generator.model.om
 */
abstract class BaseDocumentDataQuery extends ModelCriteria
{
    /**
     * Initializes internal state of BaseDocumentDataQuery object.
     *
     ...
     *
     * @return   DocumentData|DocumentData[]|mixed the result, formatted by the current formatter
     */
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = DocumentDataPeer::getInstanceFromPool((string) $key))) && !$this->formatter) {
     ...
     *
     * @return                 DocumentData A model object, or null if the key is not found
    ...
    protected function findPkSimple($key, $con)
    {
        ...
        if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            DocumentDataPeer::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|DocumentData[]|mixed the list of results, formatted by the current formatter
     */
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(DocumentDataPeer::HASH, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(DocumentDataPeer::HASH, $keys, Criteria::IN);
    }
    ...
    public function filterByHash($hash = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(DocumentDataPeer::HASH, $hash, $comparison);
    }
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(DocumentDataPeer::CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(DocumentDataPeer::CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(DocumentDataPeer::CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(DocumentDataPeer::UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(DocumentDataPeer::UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(DocumentDataPeer::UPDATED_AT, $updatedAt, $comparison);
    }
    ...
    public function filterByCreatedBy($createdBy = null, $comparison = null)
    {
        if (is_array($createdBy)) {
            ...
            if (isset($createdBy['min'])) {
                $this->addUsingAlias(DocumentDataPeer::CREATED_BY, $createdBy['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdBy['max'])) {
                $this->addUsingAlias(DocumentDataPeer::CREATED_BY, $createdBy['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(DocumentDataPeer::CREATED_BY, $createdBy, $comparison);
    }
    ...
    public function filterByUpdatedBy($updatedBy = null, $comparison = null)
    {
        if (is_array($updatedBy)) {
            ...
            if (isset($updatedBy['min'])) {
                $this->addUsingAlias(DocumentDataPeer::UPDATED_BY, $updatedBy['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedBy['max'])) {
                $this->addUsingAlias(DocumentDataPeer::UPDATED_BY, $updatedBy['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(DocumentDataPeer::UPDATED_BY, $updatedBy, $comparison);
    }
    ...
    public function filterByUserRelatedByCreatedBy($user, $comparison = null)
    {
        if ($user instanceof User) {
            return $this
                ->addUsingAlias(DocumentDataPeer::CREATED_BY, $user->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(DocumentDataPeer::CREATED_BY, $user->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByUserRelatedByUpdatedBy($user, $comparison = null)
    {
        if ($user instanceof User) {
            return $this
                ->addUsingAlias(DocumentDataPeer::UPDATED_BY, $user->getId(), $comparison);
        } elseif ($user instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
            ...
            return $this
                ->addUsingAlias(DocumentDataPeer::UPDATED_BY, $user->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByDocument($document, $comparison = null)
    {
        if ($document instanceof Document) {
            return $this
                ->addUsingAlias(DocumentDataPeer::HASH, $document->getHash(), $comparison);
    ...
    {
        return $this->addUsingAlias(DocumentDataPeer::UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(DocumentDataPeer::UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(DocumentDataPeer::UPDATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(DocumentDataPeer::CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(DocumentDataPeer::CREATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(DocumentDataPeer::CREATED_AT);
    }
