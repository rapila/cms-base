...
abstract class BaseLanguageObjectHistory extends BaseObject implements Persistent
{
     ...
     * @return LanguageObjectHistory The current object (for fluent API support)
     */
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = LanguageObjectHistoryPeer::UPDATED_BY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 8; // 8 = LanguageObjectHistoryPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = LanguageObjectHistoryPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = LanguageObjectHistoryQuery::create()
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if(Session::getSession()->isAuthenticated()) {
                    ...
                    if (!$this->isColumnModified(LanguageObjectHistoryPeer::UPDATED_BY)) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LanguageObjectHistoryPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LanguageObjectHistoryPeer::OBJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`object_id`';
        }
        if ($this->isColumnModified(LanguageObjectHistoryPeer::LANGUAGE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`language_id`';
        }
        if ($this->isColumnModified(LanguageObjectHistoryPeer::DATA)) {
            $modifiedColumns[':p' . $index++]  = '`data`';
        }
        if ($this->isColumnModified(LanguageObjectHistoryPeer::REVISION)) {
        ...
        $sql = sprintf(
            'INSERT INTO `language_object_history` (%s) VALUES (%s)',
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LanguageObjectHistoryPeer::UPDATED_AT)) $criteria->add(LanguageObjectHistoryPeer::UPDATED_AT, $this->updated_at);
        ...
        if ($this->isColumnModified(LanguageObjectHistoryPeer::UPDATED_BY)) $criteria->add(LanguageObjectHistoryPeer::UPDATED_BY, $this->updated_by);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getObjectId()) && (null === $this->getLanguageId()) && (null === $this->getRevision());
    }
    ...
    public function setContentObject(ContentObject $v = null)
    {
        ...
        if ($v !== null) {
            $v->addLanguageObjectHistory($this);
        }
    ...
    public function setUserRelatedByCreatedBy(User $v = null)
    {
        ...
        if ($v !== null) {
            $v->addLanguageObjectHistoryRelatedByCreatedBy($this);
        }
    ...
    public function setUserRelatedByUpdatedBy(User $v = null)
    {
        ...
        // If this object has already been added to the User object, it will not be re-added.
        if ($v !== null) {
            $v->addLanguageObjectHistoryRelatedByUpdatedBy($this);
        }
    ...
    public function mayOperate($sOperation, $oUser = false) {
        $oUser = LanguageObjectHistoryPeer::getRightsUser($oUser);
        $bIsAllowed = false;
        if($oUser && ($this->isNew() || $this->getCreatedBy() === $oUser->getId()) && LanguageObjectHistoryPeer::mayOperateOnOwn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        } else if(LanguageObjectHistoryPeer::mayOperateOn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        }
        FilterModule::getFilters()->handleLanguageObjectHistoryOperationCheck($sOperation, $this, $oUser, array(&$bIsAllowed));
        return $bIsAllowed;
    }
