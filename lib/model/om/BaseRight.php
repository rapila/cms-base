...
abstract class BaseRight extends BaseObject implements Persistent
{
    ...
    /**
     * Sets the value of the [is_inherited] column.
    ...
    /**
     * Sets the value of the [may_edit_page_details] column.
     * Non-boolean arguments are converted using the following rules:
     *   * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *   * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     * Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
    ...
    public function setMayEditPageDetails($v)
    {
        ...
        if ($this->may_edit_page_details !== $v) {
    ...
    /**
     * Sets the value of the [may_edit_page_contents] column.
     * Non-boolean arguments are converted using the following rules:
     *   * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *   * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     * Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
    ...
    public function setMayEditPageContents($v)
    {
        ...
        if ($this->may_edit_page_contents !== $v) {
    ...
    /**
     * Sets the value of the [may_delete] column.
     * Non-boolean arguments are converted using the following rules:
     *   * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *   * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     * Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
    ...
    /**
     * Sets the value of the [may_create_children] column.
     * Non-boolean arguments are converted using the following rules:
     *   * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *   * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     * Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
    ...
    /**
     * Sets the value of the [may_view_page] column.
     * Non-boolean arguments are converted using the following rules:
     *   * 1, '1', 'true',  'on',  and 'yes' are converted to boolean true
     *   * 0, '0', 'false', 'off', and 'no'  are converted to boolean false
     * Check on string values is case insensitive (so 'FaLsE' is seen as 'false').
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                // denyable behavior
                if(!(RightPeer::isIgnoringRights() || $this->mayOperate("insert"))) {
                ...
                // denyable behavior
                if(!(RightPeer::isIgnoringRights() || $this->mayOperate("update"))) {
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setIsInherited($this->getIsInherited());
        $copyObj->setMayEditPageDetails($this->getMayEditPageDetails());
        $copyObj->setMayEditPageContents($this->getMayEditPageContents());
        $copyObj->setMayDelete($this->getMayDelete());
        $copyObj->setMayCreateChildren($this->getMayCreateChildren());
        $copyObj->setMayViewPage($this->getMayViewPage());
    ...
    public function mayOperate($sOperation, $oUser = false) {
        ...
        if($oUser && ($this->isNew() || $this->getCreatedBy() === $oUser->getId()) && RightPeer::mayOperateOnOwn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        } else if(RightPeer::mayOperateOn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        }
