...
// actual class may be a subclass -- as returned by TagPeer::getOMClass()
...
abstract class BaseTagPeer {
	...
	{
		include_once 'model/map/TagMapBuilder.php';
		return BasePeer::getMapBuilder('model.map.TagMapBuilder');
	}
	/**
	...
	protected static function doOnDeleteCascade(Criteria $criteria, Connection $con)
	{
		...
		foreach($objects as $obj) {
			...
			$c->add(TagInstancePeer::TAG_ID, $obj->getId());
			$affectedRows += TagInstancePeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
...
if (Propel::isInit()) {
	...
	require_once 'model/map/TagMapBuilder.php';
	Propel::registerMapBuilder('model.map.TagMapBuilder');
}
