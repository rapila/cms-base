...
abstract class BaseDocumentType extends BaseObject implements Persistent
{
    ...
    /**
     * Sets the value of the [is_office_doc] column.
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = DocumentTypePeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = DocumentTypePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = DocumentTypePeer::CREATED_BY;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = DocumentTypePeer::UPDATED_BY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->extension = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->mimetype = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->is_office_doc = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
            ...
            return $startcol + 8; // 8 = DocumentTypePeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = DocumentTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = DocumentTypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                // denyable behavior
                if(!(DocumentTypePeer::isIgnoringRights() || $this->mayOperate("insert"))) {
                ...
                // denyable behavior
                if(!(DocumentTypePeer::isIgnoringRights() || $this->mayOperate("update"))) {
                    throw new PropelException(new NotPermittedException("update.by_role", array("role_key" => "documents")));
                }

                // extended_timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(DocumentTypePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // attributable behavior

                if(Session::getSession()->isAuthenticated()) {
                    if ($this->isModified() && !$this->isColumnModified(DocumentTypePeer::UPDATED_BY)) {
                        $this->setUpdatedBy(Session::getSession()->getUser()->getId());
                    }
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                DocumentTypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    {
        if (isset($alreadyDumpedObjects['DocumentType'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['DocumentType'][$this->getPrimaryKey()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DocumentTypePeer::CREATED_AT)) $criteria->add(DocumentTypePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(DocumentTypePeer::UPDATED_AT)) $criteria->add(DocumentTypePeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(DocumentTypePeer::CREATED_BY)) $criteria->add(DocumentTypePeer::CREATED_BY, $this->created_by);
        if ($this->isColumnModified(DocumentTypePeer::UPDATED_BY)) $criteria->add(DocumentTypePeer::UPDATED_BY, $this->updated_by);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setIsOfficeDoc($this->getIsOfficeDoc());
    ...
    public function setUserRelatedByCreatedBy(User $v = null)
    {
        ...
        if ($v !== null) {
            $v->addDocumentTypeRelatedByCreatedBy($this);
        }
    ...
    public function getUserRelatedByCreatedBy(PropelPDO $con = null)
    {
        if ($this->aUserRelatedByCreatedBy === null && ($this->created_by !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUserRelatedByCreatedBy->addDocumentTypesRelatedByCreatedBy($this);
             */
        }
    ...
    public function setUserRelatedByUpdatedBy(User $v = null)
    {
        ...
        // If this object has already been added to the User object, it will not be re-added.
        if ($v !== null) {
            $v->addDocumentTypeRelatedByUpdatedBy($this);
        }
    ...
    public function getUserRelatedByUpdatedBy(PropelPDO $con = null)
    {
        if ($this->aUserRelatedByUpdatedBy === null && ($this->updated_by !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByUpdatedBy->addDocumentTypesRelatedByUpdatedBy($this);
             */
        }
    ...
    public function setDocuments(PropelCollection $documents, PropelPDO $con = null)
    {
        ...
        foreach ($this->documentsScheduledForDeletion as $documentRemoved) {
            $documentRemoved->setDocumentType(null);
        }
    ...
    {
        return (string) $this->exportTo(DocumentTypePeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function mayOperate($sOperation, $oUser = false) {
        ...
        if($oUser && ($this->isNew() || $this->getCreatedBy() === $oUser->getId()) && DocumentTypePeer::mayOperateOnOwn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        } else if(DocumentTypePeer::mayOperateOn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        }
        FilterModule::getFilters()->handleDocumentTypeOperationCheck($sOperation, $this, $oUser, array(&$bIsAllowed));
        return $bIsAllowed;
    }
