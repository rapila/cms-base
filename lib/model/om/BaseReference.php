  ...
  const PEER = 'ReferencePeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 9; // 9 = ReferencePeer::NUM_COLUMNS - ReferencePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setFromModelName($this->from_model_name);
		$copyObj->setToId($this->to_id);
		$copyObj->setToModelName($this->to_model_name);
