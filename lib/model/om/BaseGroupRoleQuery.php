...
abstract class BaseGroupRoleQuery extends ModelCriteria
{
     ...
     * @param array $key Primary key to use for the query
                         A Primary key composition: [$group_id, $role_key]
     * @param     PropelPDO $con an optional connection object
     *
     * @return   GroupRole|GroupRole[]|mixed the result, formatted by the current formatter
     */
    ...
    protected function findPkSimple($key, $con)
    {
        ...
        if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $obj = new GroupRole();
            $obj->hydrate($row);
            GroupRolePeer::addInstanceToPool($obj, serialize(array((string) $key[0], (string) $key[1])));
        }
        $stmt->closeCursor();
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|GroupRole[]|mixed the list of results, formatted by the current formatter
     */
    ...
    public function filterByGroup($group, $comparison = null)
    {
        if ($group instanceof Group) {
            ...
            return $this
                ->addUsingAlias(GroupRolePeer::GROUP_ID, $group->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByRole($role, $comparison = null)
    {
        if ($role instanceof Role) {
            ...
            return $this
                ->addUsingAlias(GroupRolePeer::ROLE_KEY, $role->toKeyValue('PrimaryKey', 'RoleKey'), $comparison);
        } else {
    ...
    public function filterByUserRelatedByCreatedBy($user, $comparison = null)
    {
        if ($user instanceof User) {
            ...
            return $this
                ->addUsingAlias(GroupRolePeer::CREATED_BY, $user->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByUserRelatedByUpdatedBy($user, $comparison = null)
    {
        if ($user instanceof User) {
            ...
            return $this
                ->addUsingAlias(GroupRolePeer::UPDATED_BY, $user->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
