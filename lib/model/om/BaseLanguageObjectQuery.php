...
abstract class BaseLanguageObjectQuery extends ModelCriteria
{
     ...
     * @param array $key Primary key to use for the query
                         A Primary key composition: [$object_id, $language_id]
     * @param     PropelPDO $con an optional connection object
     *
     * @return   LanguageObject|LanguageObject[]|mixed the result, formatted by the current formatter
     */
    ...
    protected function findPkSimple($key, $con)
    {
        ...
        if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            LanguageObjectPeer::addInstanceToPool($obj, serialize(array((string) $key[0], (string) $key[1])));
        }
        $stmt->closeCursor();
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|LanguageObject[]|mixed the list of results, formatted by the current formatter
     */
