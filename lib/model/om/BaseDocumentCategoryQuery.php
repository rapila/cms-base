...
abstract class BaseDocumentCategoryQuery extends ModelCriteria
{
    ...
    public static function create($modelAlias = null, $criteria = null)
    {
        ...
        $query = new DocumentCategoryQuery(null, null, $modelAlias);
     ...
     *
     * @return   DocumentCategory|DocumentCategory[]|mixed the result, formatted by the current formatter
     */
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = DocumentCategoryPeer::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    protected function findPkSimple($key, $con)
    {
        ...
        if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            DocumentCategoryPeer::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|DocumentCategory[]|mixed the list of results, formatted by the current formatter
     */
