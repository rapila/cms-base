  ...
  const PEER = 'TagInstancePeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 7; // 7 = TagInstancePeer::NUM_COLUMNS - TagInstancePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setTaggedItemId($this->tagged_item_id);
	...
	public function getTag(PropelPDO $con = null)
	{
		if ($this->aTag === null && ($this->tag_id !== null)) {
			$this->aTag = TagQuery::create()->findPk($this->tag_id);
