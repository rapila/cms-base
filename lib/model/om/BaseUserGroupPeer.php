...
abstract class BaseUserGroupPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('UserId', 'GroupId', 'CreatedAt', 'UpdatedAt', 'CreatedBy', 'UpdatedBy', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('userId', 'groupId', 'createdAt', 'updatedAt', 'createdBy', 'updatedBy', ),
        BasePeer::TYPE_COLNAME => array (UserGroupPeer::USER_ID, UserGroupPeer::GROUP_ID, UserGroupPeer::CREATED_AT, UserGroupPeer::UPDATED_AT, UserGroupPeer::CREATED_BY, UserGroupPeer::UPDATED_BY, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USER_ID', 'GROUP_ID', 'CREATED_AT', 'UPDATED_AT', 'CREATED_BY', 'UPDATED_BY', ),
        BasePeer::TYPE_FIELDNAME => array ('user_id', 'group_id', 'created_at', 'updated_at', 'created_by', 'updated_by', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('UserId' => 0, 'GroupId' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, 'CreatedBy' => 4, 'UpdatedBy' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('userId' => 0, 'groupId' => 1, 'createdAt' => 2, 'updatedAt' => 3, 'createdBy' => 4, 'updatedBy' => 5, ),
        BasePeer::TYPE_COLNAME => array (UserGroupPeer::USER_ID => 0, UserGroupPeer::GROUP_ID => 1, UserGroupPeer::CREATED_AT => 2, UserGroupPeer::UPDATED_AT => 3, UserGroupPeer::CREATED_BY => 4, UserGroupPeer::UPDATED_BY => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USER_ID' => 0, 'GROUP_ID' => 1, 'CREATED_AT' => 2, 'UPDATED_AT' => 3, 'CREATED_BY' => 4, 'UPDATED_BY' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('user_id' => 0, 'group_id' => 1, 'created_at' => 2, 'updated_at' => 3, 'created_by' => 4, 'updated_by' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function doCountJoinUserRelatedByCreatedBy(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(UserGroupPeer::CREATED_BY, UserPeer::ID, $join_behavior);
    ...
    public static function doCountJoinUserRelatedByUpdatedBy(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(UserGroupPeer::UPDATED_BY, UserPeer::ID, $join_behavior);
    ...
    public static function doSelectJoinUserRelatedByUserId(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                $obj2->addUserGroupRelatedByUserId($obj1);
    ...
    public static function doSelectJoinUserRelatedByCreatedBy(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (UserGroup) to $obj2 (User)
                $obj2->addUserGroupRelatedByCreatedBy($obj1);
    ...
    public static function doSelectJoinUserRelatedByUpdatedBy(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (UserGroup) to $obj2 (User)
                $obj2->addUserGroupRelatedByUpdatedBy($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key4 !== null) {
                ...
                // Add the $obj1 (UserGroup) to the collection in $obj4 (User)
                $obj4->addUserGroupRelatedByCreatedBy($obj1);
            } // if joined row not null
            ...
            if ($key5 !== null) {
                ...
                // Add the $obj1 (UserGroup) to the collection in $obj5 (User)
                $obj5->addUserGroupRelatedByUpdatedBy($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of UserGroup objects pre-filled with all related objects except UserRelatedByUserId.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptGroup(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = UserGroupPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (UserGroup) to the collection in $obj3 (User)
                $obj3->addUserGroupRelatedByCreatedBy($obj1);
                ...
                // Add the $obj1 (UserGroup) to the collection in $obj4 (User)
                $obj4->addUserGroupRelatedByUpdatedBy($obj1);
    ...
    /**
     * Selects a collection of UserGroup objects pre-filled with all related objects except UserRelatedByCreatedBy.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of UserGroup objects pre-filled with all related objects except UserRelatedByUpdatedBy.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
