...
abstract class BaseDocumentCategoryPeer
{
    ...
    {
        $toNames = DocumentCategoryPeer::getFieldNames($toType);
        $key = isset(DocumentCategoryPeer::$fieldKeys[$fromType][$name]) ? DocumentCategoryPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(DocumentCategoryPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, DocumentCategoryPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return DocumentCategoryPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(DocumentCategoryPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(DocumentCategoryPeer::DATABASE_NAME);
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(DocumentCategoryPeer::$instances[$key]);
        }
    ...
    {
        return Propel::getDatabaseMap(DocumentCategoryPeer::DATABASE_NAME)->getTable(DocumentCategoryPeer::TABLE_NAME);
    }
