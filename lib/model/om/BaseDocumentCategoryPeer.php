...
// actual class may be a subclass -- as returned by DocumentCategoryPeer::getOMClass()
...
abstract class BaseDocumentCategoryPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Sort', 'MaxWidth', 'IsExternallyManaged', 'IsInactive', ),
		BasePeer::TYPE_COLNAME => array (DocumentCategoryPeer::ID, DocumentCategoryPeer::NAME, DocumentCategoryPeer::SORT, DocumentCategoryPeer::MAX_WIDTH, DocumentCategoryPeer::IS_EXTERNALLY_MANAGED, DocumentCategoryPeer::IS_INACTIVE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'sort', 'max_width', 'is_externally_managed', 'is_inactive', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Sort' => 2, 'MaxWidth' => 3, 'IsExternallyManaged' => 4, 'IsInactive' => 5, ),
		BasePeer::TYPE_COLNAME => array (DocumentCategoryPeer::ID => 0, DocumentCategoryPeer::NAME => 1, DocumentCategoryPeer::SORT => 2, DocumentCategoryPeer::MAX_WIDTH => 3, DocumentCategoryPeer::IS_EXTERNALLY_MANAGED => 4, DocumentCategoryPeer::IS_INACTIVE => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'sort' => 2, 'max_width' => 3, 'is_externally_managed' => 4, 'is_inactive' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	{
		include_once 'model/map/DocumentCategoryMapBuilder.php';
		return BasePeer::getMapBuilder('model.map.DocumentCategoryMapBuilder');
	}
	/**
	...
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = DocumentCategoryPeer::getTableMap();
	...
	const COUNT = 'COUNT(document_categories.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT document_categories.ID)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(DocumentCategoryPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(DocumentCategoryPeer::COUNT);
		}
		...
		$rs = DocumentCategoryPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
	...
	{
		return DocumentCategoryPeer::populateObjects(DocumentCategoryPeer::doSelectRS($criteria, $con));
	}
	/**
	...
	{
		return DocumentCategoryPeer::CLASS_DEFAULT;
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(DocumentCategoryPeer::ID); // remove pkey col since this table uses auto-increment
	...
	public static function doUpdate($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(DocumentCategoryPeer::ID, $criteria->remove(DocumentCategoryPeer::ID), $comparison);
	 ...
	 */
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; // rename for clarity
		} elseif ($values instanceof DocumentCategory) {
...
if (Propel::isInit()) {
	...
	try {
		BaseDocumentCategoryPeer::getMapBuilder();
	} catch (Exception $e) {
	...
	require_once 'model/map/DocumentCategoryMapBuilder.php';
	Propel::registerMapBuilder('model.map.DocumentCategoryMapBuilder');
}
