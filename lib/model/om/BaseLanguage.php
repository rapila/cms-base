...
abstract class BaseLanguage extends BaseObject  implements Persistent
{
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->collTipStrings = null;

			$this->collFrontendUsers = null;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->collTipStrings !== null) {
				foreach ($this->collTipStrings as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
			...
			if ($this->collFrontendUsers !== null) {
				foreach ($this->collFrontendUsers as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach ($this->getTipStrings() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addTipString($relObj->copy($deepCopy));
				}
			}

			foreach ($this->getFrontendUsers() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addFrontendUser($relObj->copy($deepCopy));
				}
			}
	...
	/**
	 * Clears out the collTipStrings collection
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 ...
	 * @see        addTipStrings()
	 */
	public function clearTipStrings()
	{
		$this->collTipStrings = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collTipStrings collection.
	 *
	 * By default this just sets the collTipStrings collection to an empty array (like clearcollTipStrings());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initTipStrings()
	{
		$this->collTipStrings = new PropelObjectCollection();
		$this->collTipStrings->setModel('TipString');
	}
	 ...
	 * @throws     PropelException
	 */
	public function getTipStrings($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collTipStrings || null !== $criteria) {
			if ($this->isNew() && null === $this->collTipStrings) {
				// return empty collection
				$this->initTipStrings();
			} else {
				$collTipStrings = TipStringQuery::create(null, $criteria)
					->filterByLanguage($this)
					->find($con);
				if (null !== $criteria) {
					return $collTipStrings;
				}
				$this->collTipStrings = $collTipStrings;
			}
		}
		return $this->collTipStrings;
	}
	 ...
	 * @throws     PropelException
	 */
	public function countTipStrings(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collTipStrings || null !== $criteria) {
			if ($this->isNew() && null === $this->collTipStrings) {
				return 0;
			...
			return count($this->collTipStrings);
		}
	}
	 ...
	 * @throws     PropelException
	 */
	public function addTipString(TipString $l)
	{
		if ($this->collTipStrings === null) {
			$this->initTipStrings();
		}
		if (!$this->collTipStrings->contains($l)) { // only add it if the **same** object is not already associated
			$this->collTipStrings[]= $l;
			$l->setLanguage($this);
		}
	}
	 ...
	 * Otherwise if this Language is new, it will return
	 * an empty collection; or if this Language has previously
	 * been saved, it will retrieve related TipStrings from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Language.
	 ...
	 * @return     PropelCollection|array TipString[] List of TipString objects
	 */
	public function getTipStringsJoinTip($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = TipStringQuery::create(null, $criteria);
		$query->joinWith('Tip', $join_behavior);

		return $this->getTipStrings($query, $con);
	}
	 ...
	 * @return     PropelCollection|array TipString[] List of TipString objects
	 */
	public function getTipStringsJoinUserRelatedByCreatedBy($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = TipStringQuery::create(null, $criteria);
		$query->joinWith('UserRelatedByCreatedBy', $join_behavior);
	 ...
	 * @return     PropelCollection|array TipString[] List of TipString objects
	 */
	public function getTipStringsJoinUserRelatedByUpdatedBy($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = TipStringQuery::create(null, $criteria);
		$query->joinWith('UserRelatedByUpdatedBy', $join_behavior);
	...
	/**
	 * Clears out the collFrontendUsers collection
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addFrontendUsers()
	 */
	public function clearFrontendUsers()
	{
		$this->collFrontendUsers = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collFrontendUsers collection.
	 *
	 * By default this just sets the collFrontendUsers collection to an empty array (like clearcollFrontendUsers());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initFrontendUsers()
	{
		$this->collFrontendUsers = new PropelObjectCollection();
		$this->collFrontendUsers->setModel('FrontendUser');
	}
	 ...
	 * @throws     PropelException
	 */
	public function getFrontendUsers($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collFrontendUsers || null !== $criteria) {
			if ($this->isNew() && null === $this->collFrontendUsers) {
				// return empty collection
				$this->initFrontendUsers();
			} else {
				$collFrontendUsers = FrontendUserQuery::create(null, $criteria)
					->filterByLanguage($this)
					->find($con);
				if (null !== $criteria) {
					return $collFrontendUsers;
				}
				$this->collFrontendUsers = $collFrontendUsers;
			}
		}
		return $this->collFrontendUsers;
	}
	 ...
	 * @throws     PropelException
	 */
	public function countFrontendUsers(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collFrontendUsers || null !== $criteria) {
			if ($this->isNew() && null === $this->collFrontendUsers) {
				return 0;
			...
			return count($this->collFrontendUsers);
		}
	}
	 ...
	 * @throws     PropelException
	 */
	public function addFrontendUser(FrontendUser $l)
	{
		if ($this->collFrontendUsers === null) {
			$this->initFrontendUsers();
		}
		if (!$this->collFrontendUsers->contains($l)) { // only add it if the **same** object is not already associated
			$this->collFrontendUsers[]= $l;
			$l->setLanguage($this);
		}
	}
	 ...
	 * Otherwise if this Language is new, it will return
	 * an empty collection; or if this Language has previously
	 * been saved, it will retrieve related FrontendUsers from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Language.
	 ...
	 * @return     PropelCollection|array FrontendUser[] List of FrontendUser objects
	 */
	public function getFrontendUsersJoinUserRelatedByUserId($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = FrontendUserQuery::create(null, $criteria);
		$query->joinWith('UserRelatedByUserId', $join_behavior);

		return $this->getFrontendUsers($query, $con);
	}
	 ...
	 * @return     PropelCollection|array FrontendUser[] List of FrontendUser objects
	 */
	public function getFrontendUsersJoinGame($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = FrontendUserQuery::create(null, $criteria);
	 ...
	 * @return     PropelCollection|array FrontendUser[] List of FrontendUser objects
	 */
	public function getFrontendUsersJoinUserRelatedByCreatedBy($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = FrontendUserQuery::create(null, $criteria);
		$query->joinWith('UserRelatedByCreatedBy', $join_behavior);
	 ...
	 * @return     PropelCollection|array FrontendUser[] List of FrontendUser objects
	 */
	public function getFrontendUsersJoinUserRelatedByUpdatedBy($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = FrontendUserQuery::create(null, $criteria);
		$query->joinWith('UserRelatedByUpdatedBy', $join_behavior);
	 ...
	 * @return     PropelCollection|array Comment[] List of Comment objects
	 */
	public function getCommentsJoinTipString($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = CommentQuery::create(null, $criteria);
	 ...
	 * @return     PropelCollection|array Comment[] List of Comment objects
	 */
	public function getCommentsJoinUserRelatedByCreatedBy($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = CommentQuery::create(null, $criteria);
		$query->joinWith('UserRelatedByCreatedBy', $join_behavior);
	 ...
	 * @return     PropelCollection|array Comment[] List of Comment objects
	 */
	public function getCommentsJoinUserRelatedByUpdatedBy($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = CommentQuery::create(null, $criteria);
		$query->joinWith('UserRelatedByUpdatedBy', $join_behavior);
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			...
			if ($this->collTipStrings) {
				foreach ((array) $this->collTipStrings as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collFrontendUsers) {
				foreach ((array) $this->collFrontendUsers as $o) {
					$o->clearAllReferences($deep);
				}
			}
