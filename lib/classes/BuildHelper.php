...
class BuildHelper {
  ...
  private static function compileSchemaXml() {
    $sSchemaOutputPath = ResourceFinder::findResource(DIRNAME_CONFIG, ResourceFinder::SEARCH_BASE_ONLY).'/schema.xml';
    $oSchemaTemplate = new Template('schema_prototype.xml', array(DIRNAME_CONFIG, 'flag' => "SEARCH_BASE_ONLY"));
    ...
    $aSchemaFilesNS = ResourceFinder::findResourceByExpressions(array(DIRNAME_MODULES, ResourceFinder::ANY_NAME_OR_TYPE_PATTERN, ResourceFinder::ANY_NAME_OR_TYPE_PATTERN, DIRNAME_CONFIG, "/.*\.schema\.xml/"));
