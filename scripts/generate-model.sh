...
sudo -u $owner "$PHING_PATH" -f "$path_to_buildfile" -Dproject.dir=generated/ -Dtarget=sql
sudo -u $owner "$PHING_PATH" -f "$path_to_buildfile" -Dproject.dir=generated/ -Dtarget=om
